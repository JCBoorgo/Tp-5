...
public interface iCrypto {
	 ...
	 * mots du message concorde avec les mots du dictionnaire selon un
	 * pourcentage reçu.
	 *
	 * @param message
	 *            le message à valider.
	 * @param pourcentageDeReussite
	 *            le pourcentage de réussite voulue.
	 *
	 * @return vrai si le message concorde et faux sinon.
	 */
	public boolean validerMessageSelonDico(String message, float pourcentageDeReussite);

	/**
	 * Ajuste la longueur du message reçu selon la longueur voulue. Elle ajoute
	 * autant de caractères de complément qu'il faut pour obtenir la longueur
	 * voulue. Si la longueur voulue est plus petite que la longueur du message
	 * reçu, on laisse le message intact.
	 *
	 * @param message
	 *            le message à ajuster
	 * @param longVoulue
	 *            la longueur voulue
	 *
	 * @return le massage ajusté
	 */
	public String ajusterMessageBrute(String message, int longVoulue);

	/**
	 * Permet de chiffrer le message reçu en entrée. Cette méthode choisie une
	 ...
	 * l'inverse de Hill de chacune des matrices candidates et déchiffre le massage. Une
	 * fois déchiffré elle valide les mots du message avec les mots du
	 * dictionnaire. Si la concordance des mots est bonne, la méthode conclue
	 ...
	 *
	 * @return le message déchiffrer ou null.
	 */
