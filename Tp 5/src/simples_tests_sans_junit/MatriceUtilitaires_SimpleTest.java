...
public class MatriceUtilitaires_SimpleTest {
	 ...
	 * </pre>
	 */
	int[][] mat4X4 = { { 0, 2, 1, 0 }, { 0, 5, 1, 1 }, { -1, 0, 1, 1 },
		{ 3, 1, 2, 0 } };
	 ...
	 * </pre>
	 */
	int[][] mat5X5 = { { 2, 0, 0, 0, 7 }, { 0, 9, 1, 1, 5 },
		{ -1, 0, 3, 1, 2 }, { 3, 1, 3, 0, 0 }, { 2, 4, 6, 7, 1 } };
	// int[][] mat5X5 = { { 12, 14, 17, 19, 20 }, { 30, 32, 35, 37, 38 },
	// { 43, 44, 46, 47, 49 }, { 50, 51, 53, 57, 58 }, { 62, 64, 66, 67, 69
	// } };

	// Ajout des matricse dans la liste
	...
	for (int[][] m : listeDeMat) {
	    ...
	    System.out.println(MatriceUtilitaires
		    .toStringMat(matTemp = MatriceUtilitaires
			    .getMatCofacteurs(m)));
	    ...
	    System.out.println(MatriceUtilitaires.getDeterminantInverseHill(
		    detTemp, COEF_DANS_Z));
	    ...
	    System.out
		    .println("getMatModuloX de la matrice précédente où on applique un modulo, la constante "
			    + COEF_DANS_Z);
	    System.out.println(MatriceUtilitaires
		    .toStringMat(MatriceUtilitaires.getMatModuloX(matTemp,
			    COEF_DANS_Z)));
	}
    }
}
